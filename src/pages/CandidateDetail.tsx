              ...
              {isEditingPersonal ? (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1 md:col-span-2">
                    ...
                    <input type="url" value={personalForm.portal_link || ''} onChange={e => setPersonalForm({...personalForm, portal_link: e.target.value})} placeholder="https://portal.example.com" className="w-full bg-bg-tertiary border border-border-primary rounded-lg px-3 py-2 text-sm" />
                  </div>
                  <div className="space-y-1 md:col-span-2">
